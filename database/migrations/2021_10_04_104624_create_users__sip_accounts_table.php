...
class CreateUsersSipAccountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users_sip_accounts', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement("ALTER TABLE `users_sip_accounts` comment 'Users SIP Accounts'");
    }
    ...
    {
        Schema::dropIfExists('users_sip_accounts');
    }
}
