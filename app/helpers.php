...
if (!function_exists('getCompanieClassByName')) {
    function getCompanieClassByName($class): int
    {
...
if (!function_exists('getSourceByName')) {
    function getSourceByName($source): int
    {
...
if (!function_exists('getStatusByName')) {
    function getStatusByName($status): int
    {
...
if (!function_exists('getProfileByName')) {
    function getProfileByName($profile): int
    {
...
if (!function_exists('getCountryName')) {
    function getCountryName($code): string
    {
        ...
        return $country[strtoupper($code)];
    }
}
...
if (!function_exists('getLanguageName')) {
    ...
    {
        $language = ["AR" => "Arabic - العربية", "EN" => "English", "FR" => "French - français", "ES" => "Spanish - español"];
        return $language[strtoupper($code)];
    }
}
