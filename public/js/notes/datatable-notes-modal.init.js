$(document).ready(function () {
    var a = $("#datatable-notes-modal").DataTable({
        lengthChange: !1,
        buttons: [
    ...
    a.buttons().container().appendTo("#datatable-notes-modal_wrapper .col-md-6:eq(0)"),
    ...
    $('#datatable-notes-modal tfoot th').each(function () {
        var title = $(this).text();
