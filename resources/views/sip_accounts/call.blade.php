...
<!-- Modal -->
<div id="call-two-modal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="multiple-twoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content modal-filled bg-success">
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    alt="contact-data-logo" height="200" class="me-1"><br><br><br>
                    <button type="button" data-bs-dismiss="modal" class="btn btn-danger btn-rounded waves-effect waves-light">
