    <!-- Modal -->
    <div class="modal fade" id="edit-sip_account-modal" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form class="form-horizontal" id="edit-sip_account" method="POST" action="#" data-parsley-validate=""
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            @csrf
                            @method('put')
                            <input type="hidden" name="id" id="edit-sip_account-id">
                            <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit-sip_account-channel_id" class="form-label">Channel</label>
                                        <select class="form-select @error('channel_id') parsley-error @enderror"
                                            name="channel_id" id="edit-sip_account-channel_id" required
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit-sip_account-host" class="form-label">Host</label>
                                        <input type="text" class="form-control" id="edit-sip_account-host" name="host"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit-sip_account-username" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="edit-sip_account-username"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit-sip_account-name" class="form-label">Name</label>
                                        <input type="name" class="form-control" id="edit-sip_account-name" name="name"
                                            placeholder="Name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit-sip_account-priority" class="form-label">Priority</label>
                                        <select class="form-select @error('priority') parsley-error @enderror"
                                            name="priority" id="edit-sip_account-priority" required
