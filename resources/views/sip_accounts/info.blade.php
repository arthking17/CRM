            ...
            <div class="card-body">
                @if(isset($sip_account))
                    <div class="w-100" id="sip_accounts-info1">
                        <h4 class="mt-0 mb-1">Id : {{ $sip_account->id }}</h4>
                        <p class="text-muted"><i class="mdi mdi-phone"></i>Account :
                            {{ $sip_account->account[0]->name }}</p>
                        <p class="text-muted"><i class="mdi mdi-account"></i>Channel :
                            {{ $sip_account->channel[0]->name }}</p>
                        <p class="text-muted d-none"> {{ $sip_account->id }}</p>
                        ...
                        @if ($sip_account->status === 1)
                            <a id="edit-{{ $sip_account->id }}" class="btn- btn-xs btn-primary js--tippy"
