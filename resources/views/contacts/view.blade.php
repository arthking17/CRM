...
@section('js')
    ...
    <script src="{{ asset('js/contacts/data/contact-data.js') }}"></script>
    <script src="{{ asset('js/contacts/data/add-phone-data.js') }}"></script>
    <script src="{{ asset('js/contacts/data/edit-phone-data.js') }}"></script>
