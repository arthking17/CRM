                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-8 col-xl-9">
                                                    @if ($custom_field->field_type === 'text' || $custom_field->field_type === 'number' || $custom_field->field_type === 'url' || $custom_field->field_type === 'datetime')
                                                        ...
                                                        class="form-control @if ($custom_field->field_type === 'datetime') datetimepicker @endif
                                                        @error($custom_field->tag) parsley-error @enderror"
                                                        name="{{ $custom_field->tag }}"
                                                        id="form_edit-{{ $custom_field->tag }}"
                                                    ...
                                                    @elseif($custom_field->field_type === 'month')
                                                        <input type="text" class="form-control"
                                                            data-provide="datepicker" data-date-format="MM yyyy" placeholder="MM yyyy"
                                                            data-date-min-view-mode="1"
                                                            name="{{ $custom_field->tag }}"
                                                            id="form_edit-{{ $custom_field->tag }}">
                                                    @elseif($custom_field->field_type === 'date')
                                                        <input type="text" class="form-control"
                                                            data-provide="datepicker" placeholder="MM yyyy DD"
                                                            name="{{ $custom_field->tag }}"
                                                            id="form_edit-{{ $custom_field->tag }}">
                                                    ...
                                                    <a id="form_edit-{{ $custom_field->tag }}-preview"
                                                        class="d-none" href="#" target="_blank">view existing
                                                        {{ $custom_field->tag }}</a><a id="form_edit-{{ $custom_field->tag }}-delete" href="javascript:void(0);" class="action-icon d-none" onclick="#"> <i
