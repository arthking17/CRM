@extends('layouts.app', ['title' => 'SMS Chat'])
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">SMS Chat</li>
                            </ol>
                        </div>
                        <h4 class="page-title">SMS Chat</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <div class="conversation-text">
                                        <div class="ctext-wrap">
                                            ...
                                            <p>
                                                ...
                                                to finalize today. I am attaching the last year format and assets here...
                                            </p>
                                        </div>
