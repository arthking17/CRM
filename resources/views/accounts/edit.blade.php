        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form class="form-horizontal parsley-account" id="edit-account" method="POST" action="#" data-parsley-validate="" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-8 col-xl-9">
                                <input type="url"
                                    ...
                                    id="edit-account-url" name="url" placeholder="Url" required
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-8 col-xl-9">
                                <select
                                    ...
                                    name="status" id="edit-account-status" required data-parsley-type="integer"
