                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <a href="apps-calendar.html" class="dropdown-item"><i class="fe-calendar me-1"></i>
                                Calendar</a>
                            <a href="apps-chat.html" class="dropdown-item"><i class="fe-message-square me-1"></i>
                                Chat</a>
                            <div class="dropdown">
                            ...
                            <a href="apps-social-feed.html" class="dropdown-item"><i class="fe-rss me-1"></i> Social
                                Feed</a>
                            <a href="apps-companies.html" class="dropdown-item"><i class="fe-activity me-1"></i>
                                Companies</a>
                            ...
                            <a href="apps-file-manager.html" class="dropdown-item"><i class="fe-folder-plus me-1"></i>
                                File Manager</a>
                        </div>
                    </li>
