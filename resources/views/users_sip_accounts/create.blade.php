    <!-- Modal -->
    <div class="modal fade" id="create-users_sip_account-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h4 class="modal-title" id="myCenterModalLabel">Add User SIP Account</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="form-horizontal" id="create-users_sip_account" method="POST" action="#" data-parsley-validate=""
                    novalidate>
                    <div class="modal-body p-4">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="create-users_sip_account-user_id" class="form-label">User</label>
                                        <select class="form-select @error('user_id') parsley-error @enderror"
                                            name="user_id" id="create-users_sip_account-user_id"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="create-users_sip_account-sipaccount_id" class="form-label">SIP Account</label>
                                        <select class="form-select @error('sipaccount_id') parsley-error @enderror"
                                            name="sipaccount_id" id="create-users_sip_account-sipaccount_id"
                                            required data-parsley-length="[1, 10]"
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn-create-users_sip_account"
