                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-8 col-xl-9" id="div-language">
                                                ...
                                                <select class="form-select @error('language') parsley-error @enderror"
                                                    name="language" id="language" required data-parsley-length="[2, 5]">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row mb-3">
                                            <label for="timezone" class="col-4 col-xl-3 col-form-label">timezone<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-8 col-xl-9" id="div-timezone">
                                                <input name="timezone-val" type="text" id="timezone-val"
                                                    value="{{ $user->timezone }}" hidden>
                                                <select class="form-select @error('timezone') parsley-error @enderror"
                                        ...
                                        <div class="row mb-3">
                                            <label for="browser" class="col-4 col-xl-3 col-form-label">browser<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-8 col-xl-9" id="div-browser">
                                                <input type="browser"
                                                    class="form-control @error('browser') parsley-error @enderror"
                                                    id="browser" name="browser" value="{{ $user->browser }}"
                                                    placeholder="browser" required>
                                                @error('browser')
                                                    <ul class="parsley-errors-list filled" aria-hidden="false">
                                        ...
                                        <div class="row mb-3">
                                            <label for="ip_address" class="col-4 col-xl-3 col-form-label">ip_address<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-8 col-xl-9" id="div-ip_address">
                                                <input type="ip_address"
                                                    class="form-control @error('ip_address') parsley-error @enderror"
                                                    id="ip_address" name="ip_address" value="{{ $user->ip_address }}"
                                                    placeholder="ip_address" required
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-8 col-xl-9" id="div-photo">
                                                <input type="file"
                                                    ...
                                                    data-parsley-fileextension='jpg,png,jpeg' data-height="30px">
                                                @error('photo')
                                                    <ul class="parsley-errors-list filled" aria-hidden="false">
