            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form class="form-horizontal parsley-user" id="edit-user" method="POST" action="#"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-xl-9" id="div-username">
                                        <input type="text"
                                            ...
                                            id="edit-username" name="username"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-xl-9" id="div-login">
                                        <input type="text"
                                            class="form-control @error('login') parsley-error @enderror" id="edit-login"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-xl-9" id="div-role">
                                        <select class="form-select @error('role') parsley-error @enderror"
                                            name="role" id="edit-role" required data-parsley-type="integer"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-xl-9" id="div-language">
                                        <select class="form-select @error('language') parsley-error @enderror"
                                            name="language" id="edit-language" required data-parsley-length="[2, 5]" data-parsley-length-message="select a language">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8 col-xl-9" id="div-account">
                                        <select class="form-select @error('account_id') parsley-error @enderror"
                                            name="account_id" id="edit-account_id" required data-parsley-type="integer">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9" id="div-photo">
                                    <input type="file"
                                        class="form-control dropify @error('photo') parsley-error @enderror" id="edit-photo"
                        ...
                        <!-- end row-->
                        <button type="submit" id="edit" class="btn btn-info waves-effect waves-light">Edit</button>
