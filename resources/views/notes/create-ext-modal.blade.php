    <!-- Modal -->
    <div class="modal fade" id="create-note-2-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal parsley-note" id="create-note-2" method="POST" action="#"
                    data-parsley-validate="" novalidate>
                    <div class="modal-body p-4">
                        <div class="row">
                            @csrf
                            <input type="number" name="element" id="create-note-2-element" hidden />
                            <input type="number" name="element_id" id="create-note-2-element_id" hidden />
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <select class="form-select @error('class') parsley-error @enderror" name="class"
                                        id="create-note-2-class" required data-parsley-type="integer"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <select class="form-select @error('visibility') parsley-error @enderror"
                                        name="visibility" id="create-note-2-visibility" required
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <textarea class="form-control @error('content') parsley-error @enderror"
                                        name="content" id="create-note-2-content" placeholder="content" rows="3" required
                    ...
                    <div class="modal-footer bg-light">
                        <button type="submit" id="btn-create-note-2" class="btn btn-primary waves-effect waves-light"><i
