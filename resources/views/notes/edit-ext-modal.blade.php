    <!-- Modal -->
    <div class="modal fade" id="edit-note-2-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal parsley-note" id="edit-note-2" method="POST" action="#"
                    data-parsley-validate="" novalidate>
                    <div class="modal-body p-4">
                        <div class="row">
                            @csrf
                            @method('put')
                            <input type="number" name="id" id="edit-note-2-id" hidden />
                            <input type="number" name="element" id="edit-note-2-element" hidden />
                            <input type="number" name="element_id" id="edit-note-2-element_id" hidden />
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <select class="form-select @error('class') parsley-error @enderror" name="class"
                                        id="edit-note-2-class" required data-parsley-type="integer"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <select class="form-select @error('visibility') parsley-error @enderror"
                                        name="visibility" id="edit-note-2-visibility" required data-parsley-type="integer"
                                        data-parsley-length="[1, 1]">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-xl-9">
                                    <textarea class="form-control @error('content') parsley-error @enderror"
                                        name="content" id="edit-note-2-content" placeholder="content" rows="3" required
                    ...
                    <div class="modal-footer bg-light">
                        <button type="submit" id="btn-edit-note-2"
                            ...
                            <button type="button" class="btn btn-secondary waves-effect waves-light m-1"
                                onclick="$('#edit-note-2-modal').modal('toggle')"><i class="fe-x me-1"></i>Cancel</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
